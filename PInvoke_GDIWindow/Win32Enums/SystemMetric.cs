...
namespace GDIWindow.Win32Enums
{
    public enum SystemMetric
    {
        ...
        /// <summary>
        /// The width of a Zone cell for items in large icon view, in pixels. Each item fits into a rectangle of size
        ...
        /// <summary>
        /// The width of a Zone cell for a minimized window, in pixels. Each minimized window fits into a rectangle this size when arranged.
        ...
        /// <summary>
        /// The height of a Zone cell for items in large icon view, in pixels. Each item fits into a rectangle of size
        ...
        /// <summary>
        /// The height of a Zone cell for a minimized window, in pixels. Each minimized window fits into a rectangle this size when arranged.
